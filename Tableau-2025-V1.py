...
class TournamentBracket:
    ...
    def gestion_vainqueur(self, player1, player2, dossard1, dossard2, level, index_match, tableau, nb_tops, intertop, scores_sets):
        if (intertop):
    ...
    def handle_enter(self, event, entries, player1, player2, level, index_match, tableau, nb_tops, intertop):
        ...
        if current_index < len(entries):
            ...
            if ( (sets_player1 == 2 and mode == "2 sets") or
                ...
                self.gestion_vainqueur(player1, player2, dossard1, dossard2, level, index_match, tableau, nb_tops, intertop, scores_sets)   
                current_widget.focus_set()
            elif ( (sets_player2 == 2 and mode == "2 sets") or
                (sets_player2 == 3 and mode == "3 sets") ):                                          
                self.gestion_vainqueur(player2, player1, dossard2, dossard1, level, index_match, tableau, nb_tops, intertop, scores_sets)
                current_widget.focus_set()
            else:
