...
class TournamentBracket:
    ...
    def load_tournament(self, Tableau):
        ...
        if self.nb_tops < 2:
            ...
            if (Tableau == "InterTops"):
                messagebox.showinfo(title="Info", message="Pas d'Intertops")
                return
        ...
        while (nb_matches >=1):
            ...
            for round_mid_y in next_round_positions:
                ...
                if (index_player == 1):
                    ...
                    if (j1 == "---"):
                        fillColor = "grey"
                    self.canvas.create_rectangle(start_x, y1_top, start_x + longueur_rectangle, y1_bottom, outline="black", width=1, fill=fillColor)
                    if (j1 != ""):
                    ...
                    if (j2 == "---"):
                        fillColor = "grey"
                    self.canvas.create_rectangle(start_x, y2_top, start_x + longueur_rectangle, y2_bottom, outline="black", width=1, fill=fillColor)
                    if (j2 != ""):
