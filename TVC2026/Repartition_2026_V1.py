...
import os
import sys
from modules.utils import charger_config_categorie
from modules.bracket import construire_bracket
from modules.tvc_V20 import repartir_poules_sans_conflit, charger_joueurs, filtrer_et_trier_joueurs, lire_excel_name, update_word_and_json
        ...
        def obtenir_infos_paires():
            ...
            for element_dict in tableauOk:
                ...
                if valeur > nb_poules * 2:
                    ...
                    data.append({"grise": False, "poule_idx": valeur - 1, "type": "3ème"})
                else:
                    X = nb_poules
                    V = valeur
                    ...
                    data.append({"grise": is_3, "poule_idx": idx - 1, "type": "4eme"})
            return data
