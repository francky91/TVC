...
from modules.json_access import *
import json
import os
...
def construire_tops_2_poules(joueurs_top):
    ...
    print(f"poule_top1: {poule_top1}")
    print(f"poule_top2: {poule_top2}")
...
def repartir_poules_sans_conflit(fichier_entree, feuille_source_resultat, nb_poules_top, nb_poules_3=None, nb_poules_4=None, nb_poules_5=None):
    ...
    if (nb_poules_3 != None and nb_poules_4 != None):
        ...
        if (nbTotal != nbJoueurs):
            ...
            exit()
    '''
    print(f"nb_poules_top: {nb_poules_top}, nb_poules_3: {nb_poules_3}, nb_poules_4: {nb_poules_4}, nb_poules_5: {nb_poules_5}")
    if nb_poules_top > 0:
