...
from utils import charger_config, charger_config_categorie
import json
import os
...
def filtrer_et_trier_joueurs(joueurs):
    ...
    #print("ligne: ", joueurs['nom'], " ", joueurs['prenom'], " ", joueurs['Tour4'])
    ...
    if (joueurs['Tour4'].str.contains('X', case=False, na=False).any()):
        ...
        print("Nb Joueurs Inscrits Tour4: ", nbJoueurs)
        ...
        print("Nb Joueurs Inscrits Tour3: ", nbJoueurs)
        return joueurs.sort_values(by='points', ascending=False), True, tourActif, nbJoueurs
        ...
        print("Nb Joueurs Inscrits Tour2: ", nbJoueurs)
        return joueurs.sort_values(by='points', ascending=False), True, tourActif, nbJoueurs
    else:
...
if __name__ == "__main__":
    ...
    try:
        ...
        nb_tops_defaut = int(charger_config_categorie(config_file, args.Categorie))
